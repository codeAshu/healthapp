...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	private static final String TABLE_DOC = "login_doc";
	...
	String CREATE_DOC_LOGIN_TABLE = "CREATE TABLE " + TABLE_DOC + "("
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL(CREATE_DOC_LOGIN_TABLE);
	...
	public void addDoc(String name, String email, String type, String uid, String created_at) {
		SQLiteDatabase db = this.getWritableDatabase();

		ContentValues values = new ContentValues();
		values.put(KEY_NAME, name); // Name
		values.put(KEY_EMAIL, email); // Email
		values.put(KEY_TYPE, type); // speciality
		values.put(KEY_UID, uid); // Email
		values.put(KEY_CREATED_AT, created_at); // Created At
